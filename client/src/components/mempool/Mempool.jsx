...
const Mempool = () => {
	const address = "04875a5ee53110a1ce856f2fc549671456afcc62a510d96cb8e05ca0cb65f78c0b1fb880db8ac195cee93d2d6eff917e795f224d63a2c73319b1ce1e42f27395a4";
	...
	return (
		<div className="mempool-container">
			...
			<div className="mempool-peer-container">
				<MempoolPeer data={txPool.data} port={3001} handleOnClick={()=>miningClick(3001, address)} loading={txPool.loading} />
				<MempoolPeer data={txPool2.data} port={3002} handleOnClick={()=>miningClick(3002, address)} loading={txPool2.loading} />
				<MempoolPeer data={txPool3.data} port={3003} handleOnClick={()=>miningClick(3002, address)} loading={txPool3.loading} />
			</div>
		</div>
	);
};
